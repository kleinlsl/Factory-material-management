...
{
    public partial class ModifyOutInventoryForm : Form
    {
        ...
        public ModifyOutInventoryForm()
        {
            ...
            sadp.SelectCommand.CommandText = "select distinct ComponentID from OutInfo";
            sadp.Fill(ds);
        ...
        public ModifyOutInventoryForm(string LJID, string CKID, string RKSJ)
        {
        ...
        private void Save_button_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sql = "select * from OutInfo where ComponentID='" + this.LJBH_comboB.Text.Trim() + "' " +
                ...
                {
                    sql = "update OutInfo set ComponentID='" + this.LJBH_comboB.Text.Trim() + "',WarehouseID='" + this.CKBH_comboBoxB.Text.Trim() + "',OutNum=" + this.RKSL_textB.Text.Trim() +
                        " where ComponentID='" + this.LJBH_comboB.Text.Trim() + "' and WarehouseID='" + this.CKBH_comboBoxB.Text.Trim() + "' and Outdate='" + this.RKSJ_dateTimeP.Text.Trim() + "'";
                    //  MessageBox.Show(sql,"");
        ...
        private void LJBH_comboB_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                if (CKID == null)
                {
                    ...
                    sadp.SelectCommand.CommandText = "select distinct WarehouseID from OutInfo where ComponentID='" + this.LJBH_comboB.Text.Trim() + "'";
                    sadp.Fill(ck);
        ...
        private void RKSJ_dateTimeP_ValueChanged(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sadp = new SqlDataAdapter("", sqlconn);
            string sql = "" +
                "select OutNum, EmployeeName " +
                "from OutInfo,Employee" +
                " where OutInfo.OutEmployeeID=Employee.EmployeeID and " +
                "OutInfo.ComponentID='" + this.LJBH_comboB.Text.Trim() + "' " +
                "and OutInfo.WarehouseID='" + this.CKBH_comboBoxB.Text.Trim() + "' " +
                "and Outdate='" + this.RKSJ_dateTimeP.Value.ToString("yyyy-MM-dd").Trim() + "'";
            //   MessageBox.Show(sql,"");
            sadp.SelectCommand.CommandText = sql;
            sadp.Fill(ds);
            if (ds.Tables[0].Rows.Count > 0)
        ...
        private void ModifyOutInventoryForm_Load(object sender, EventArgs e)
        {
